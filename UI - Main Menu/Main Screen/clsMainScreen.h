...
private:
    ...
    enum enMainMenuOptions {enShowClientList = 1, enAddNewClient = 2, enDeleteClient = 3, enUpdateClientInfo = 4, enFindClient = 5, enTransactions = 6, enManageUsers = 7, enLoginRegisterHistory = 8,enLogout = 9};

    static short _ReadMainMenuOption()
    {
        cout << endl << endl << setw(40) << left << "" << "what do you want to do?\n" << setw(40) << left << "" << "Please choice an option from 1 to 9: ";
...
public:
    ...
    static void ShowMainMenu()
    {
        ...
        cout << setw(20) << left << ""<< "\t\t\t[9] Logout." << endl;
        cout << setw(20) << left << ""<< "\t\t\t===========================================================================\n" << endl;
